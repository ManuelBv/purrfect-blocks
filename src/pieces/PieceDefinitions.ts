...
// Square pieces (1x1 through 3x3) - limited to 3x3 for 8x8 board
...
// Total: 16 tetromino rotations + 3 squares = 19 pieces
console.assert(PIECE_DEFINITIONS.length === 19, 'Should have exactly 19 piece definitions');
